        ...
        {produts?.map((item, index)=>{
            ...
            <div className="relative overflow-hidden h-44">
                ...
                <Link to={`/product/${item._id}`}>
                    <img alt="" className="item-img max-w-full h-44 w-full rounded-[7px] object-cover" src={item.img} />
                </Link>
            ...
            <div className="my-0 mx-2">
                <h3 className="my-[3px] mx-0 h-auto">
                    <Link className="font-normal text-[15px] block w-[190px] truncate" to="">{item.name}</Link>
                </h3>

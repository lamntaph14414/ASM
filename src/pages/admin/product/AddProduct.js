...
import { listCate } from '../../../features/category/cateProSlice';
    ...
    return (
        <>
            <div className="container px-6 mx-auto grid">
                <h2 className="my-6 text-2xl font-semibold text-gray-700 :text-gray-200">Products</h2>
                ...
                <div className="grid grid-cols-2 gap-8">
                    <form className='' id='form-add' onSubmit={handleSubmit(onSubmit)}>
                        <div className='b-4'>
                            ...
                            <input className=" appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:-outline" id="title-product" type="text" {...register('name', {required: true})}/>
                        ...
                        <div className="grid grid-cols-2 gap-5">
                            <div className="m-full">
                                ...
                                <div className="mb-3">
                                    <input type="text" className="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" id="img-product" {...register('img', {required:true})}/>
                                </div>
                            </div>
                        ...
                        <div className="mb-4">
                            <label className="block :text-white text-gray-700 text-sm font-bold mb-2">Size</label>
                        ...
                        <div className="mb-4">
                            <label className="block :text-white text-gray-700 text-sm font-bold mb-2">Description</label>
                            <textarea className="w-full" id="desc-product" {...register('desc')} ></textarea>
                        </div>
                        <div className="text-right">
                            <button className="btnAdd bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:-outline">Submit</button>
                        </div>
                    </form>
                    <div className='img'>
